 ...
 * or remove products, and customers who can browse, sort, and purchase products.
 */
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (mainSelection == 1) {
                ...
                ArrayList<Sellable> shoppingCart = new ArrayList<Sellable>();
                do {
                    System.out.println("\n---- Customer Menu ----");
